...
/**
 * Shared Postgres bootstrap for Spring integration tests that load full application context.
 */
public abstract class PostgresIntegrationTestSupport {
    ...
    private static synchronized void ensurePostgresStarted() {
        ...
        postgresContainerName = "app-test-postgres-" + UUID.randomUUID();
        runCommand("docker", "run", "-d", "--rm",
                ...
                "-P",
                "postgres:17-alpine");
        Runtime.getRuntime().addShutdownHook(new Thread(PostgresIntegrationTestSupport::stopPostgresContainer));
    ...
    private static synchronized void stopPostgresContainer() {
